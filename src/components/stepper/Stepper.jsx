...
const Stepper = ({ steps, currentStep }) => {
  return (
    <ol className="flex items-center w-full text-sm poppins-regular text-center text-gray-500 dark:text-gray-400 sm:text-base">
        ...
        return (
          <li
            ...
            className={`flex md:w-full items-center ${
              ...
              isActive || isCompleted ? "text-blue-600 dark:text-blue-500" : ""
            }`}
          >
            <span
              className={`flex items-center text-sm poppins-regular ${
                index < steps.length - 1
